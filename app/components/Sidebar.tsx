...
const Sidebar = () => {
  ...
  return (
    <div className="z-10 pl-4 absolute bottom-0">
      <motion.div
      ...
      >
        ...
        >
          <motion.svg
            ...
            className="text-5xl py-1 hover:text-slate-100"
            height="1em"
            width="1em"
        ...
        <Link rel="preload" aria-label="upwork" href="https://www.upwork.com/">
          <motion.svg
            variants={iconVariant}
            stroke="currentColor"
            fill="none"
          ...
          {/* <IconContext.Provider
            value={{ className: "text-5xl py-1 hover:text-slate-100" }}
          >
            <TbBrandUpwork />
          </IconContext.Provider> */}
        </Link>
        <Link rel="preload" aria-label="fiverr" href="https://www.fiverr.com/">
          <motion.svg
            variants={iconVariant}
            stroke="currentColor"
            fill="none"
        ...
        <Link
          rel="preload"
          aria-label="email"
          href="https://mail.google.com/mail/?view=cm&fs=1&to=mikepadial@gmail.com"
        >
          <motion.svg
            variants={iconVariant}
            stroke="currentColor"
        ...
        <Link rel="preload" aria-label="medium" href="https://www.medium.com/">
          <motion.svg
            variants={iconVariant}
            stroke="currentColor"
            fill="currentColor"
